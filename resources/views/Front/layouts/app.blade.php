    ...
    <header class="fixed top-0 w-full z-50 bg-[#080313]/60 backdrop-blur-xl border-b border-white/10 shadow-lg">
        <div class="flex justify-between items-center max-w-container-max mx-auto px-gutter h-20">
            ...
            <nav class="hidden md:flex items-center space-x-8">
                <a href="/about#solutions" class="font-body text-sm font-medium transition-all duration-200 {{ request()->is('about') && request()->hash == 'solutions' ? 'text-secondary border-b-2 border-secondary pb-1' : 'text-on-surface-variant hover:text-white' }}">Solutions</a>
